...
print('Exercise 1a:', calculate_area_triangle(7, 3))
...
print('Exercise 2a:', simple_interest(1500, 3.5, 5))
...
def apply_discount(price, discount_persenatge ):
   new_price = price - (price * (discount_persenatge * 0.01))
   return new_price

print('Exercise 3:', apply_discount(100, 25))
print('Exercise 3a:', apply_discount(80, 10))
